...
class EditSpaceInfoScreen extends StatefulWidget {
  const EditSpaceInfoScreen({super.key});

  @override
  State<EditSpaceInfoScreen> createState() => _EditSpaceInfoScreenState();
}

class _EditSpaceInfoScreenState extends State<EditSpaceInfoScreen> {
  ...
  void _submit() {
    Get.snackbar('Success', 'Space info updated');
  }
      ...
      child: SingleChildScrollView(
        ...
        child: Column(
          ...
          children: [
            ...
            PrimaryButton(text: 'Save', isLoading: false, onPressed: _submit),
